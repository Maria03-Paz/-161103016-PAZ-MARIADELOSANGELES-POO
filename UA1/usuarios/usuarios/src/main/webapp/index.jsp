        ...
        <table  class="table table-hover table-responsive-sm " align="center" style="width:55%">
            <thread class="thread-dark">
                <tr>
                    ...
                    <td>  </td>
                    <td><a class="btn btn-dark btn-block" href="password.jsp">Editar Password</a></td>
                    <td>  </td>
                </tr>
                <tr>
                    <th scope="col">#</th>
            ...
            <tbody>    
              ...
              <% while (rs.next()) {%>
                <tr>
                    ...
                    <td><a class="btn btn-warning btn-block"  href="formulario.jsp?id=<%= rs.getInt("id_usuario")%>">Editar</a> </td>
